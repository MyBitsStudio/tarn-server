...
public class GlobalDoubleDRTask extends Task {
    ...
    protected void execute() {
                    if (timer < 1) {
                        ...
                        AdminCord.sendMessage(1108220766320861224L, "2X Drop Rate Event has begun for 60 minutes!");
                        ...
                        AdminCord.sendMessage(1108220766320861224L, "2X Drop Rate Event has ended!");
