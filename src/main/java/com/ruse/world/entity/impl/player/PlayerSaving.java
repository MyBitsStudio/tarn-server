...
//		if (player.newPlayer() || player.isMini())
//			return;
...
//			object.addProperty("aggro-timer", new Integer(player.getAggroPotionTimer()));
//			object.addProperty("exp-timer", new Integer(player.getExpPotionTimer()));
//			object.addProperty("dr-timer", new Integer(player.getDrPotionTimer()));
//			object.addProperty("ddr-timer", new Integer(player.getDdrPotionTimer()));
//			object.addProperty("dmg-timer", new Integer(player.getDmgPotionTimer()));
//
