...
//        int result = player.getPSecurity().loginCode();
    ...
    public static int getResult(Player player) {
        ...
        try (FileReader fileReader = new FileReader(file)) {
            ...
            if (reader.has("secondary-equipment")) {
                player.getSecondaryEquipment()
                        .setItems(builder.fromJson(reader.get("secondary-equipment").getAsJsonArray(), Item[].class));
            }
            ...
            if (reader.has("new-uim-bank")) {
                player.setUIMBank(
                        new UimBank(player)).getUIMBank()
                        .addItems(builder.fromJson(reader.get("new-uim-bank").getAsJsonArray(), Item[].class), false);
            }
            ...
            if (reader.has("is-secondary-equipment")) {
                player.setIsSecondaryEquipment(reader.get("is-secondary-equipment").getAsBoolean());
            }
            ...
            if (reader.has("secondary-equipment-slots-unlocked")) {
                player.setSecondaryEquipmentUnlocks(builder.fromJson(reader.get("secondary-equipment-slots-unlocked").getAsJsonArray(), boolean[].class));
            }
            ...
            if (reader.has("collectionlog-rewards")) {
                HashMap<Integer, CollectionLogInterface.RewardClaim> rewardClaimHashMap = builder.fromJson(reader.get("collectionlog-rewards"),
            ...
            if(reader.has("battlepass-xp")) {
                player.getBattlePass().setXp(reader.get("battlepass-xp").getAsInt());
            }
            if (reader.has("battlepass-premium")) {
                player.getBattlePass().setPremium(reader.get("battlepass-premium").getAsBoolean());
            }

            if (reader.has("drystreak")) {
                HashMap<Integer, Integer> dryStreakMap = builder.fromJson(reader.get("drystreak"),
            ...
            if(reader.has("boost")) {
                player.getEquipmentEnhancement().setBoost(reader.get("boost").getAsLong());
            }
            if(reader.has("slot-level")) {
