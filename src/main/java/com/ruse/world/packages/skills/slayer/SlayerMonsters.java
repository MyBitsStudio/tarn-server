...
public enum SlayerMonsters {
    ...
    BLURITE_GOBLIN(9837, 0, 10, 9,
            false, false,new int[]{1, 25}),
    BLURITE_ORC(9027, 0, 10, 9,
            false, false,new int[]{1, 25}),
    BLURITE_DEMON(9835, 0, 10, 9,
            false,false, new int[]{1, 25}),
    BLURITE_WEREWOLF(9911, 0, 10, 9,
            false, false,new int[]{1, 25}),
    BLURITE_CENTUAR(9922, 0, 10, 9,
            false,false, new int[]{1, 25}),

    ZINQRUX(8014, 0, 15, 12,
            false,false, new int[]{1, 50}),
    ABBARANT(8003, 0, 15, 12,
            false,false, new int[]{1, 50}),
    NAGENDRA(811, 0, 15, 12,
            false,false, new int[]{1, 50}),
    YISDAR(9817, 0, 15, 12,
            false,false, new int[]{1, 50}),
    DOOMWATCHER(9836, 0, 15, 12,
            false,false, new int[]{1, 50}),

    MAZE(92, 0, 22, 16,
            false,false, new int[]{1, 65}),
    MISCREATION(3313, 0, 22, 16,
            false,false, new int[]{1, 65}),
    ZORBAK(1906, 0, 22, 16,
            false, false,new int[]{1, 65}),

    UNICORN(1742, 0, 29, 21,
            false,false, new int[]{5, 75}),
    HYNDRA(1743, 0, 29, 21,
            false, false,new int[]{5, 75}),
    GROOTER(1744, 0, 29, 21,
            false,false, new int[]{5, 75}),
    RUNITE(1745, 0, 29, 21,
            false, false,new int[]{5, 75}),
    ...
    AGUMON(3020, 2, 112, 78,
            true, false, new int[]{72, 565}),
    BOWSER(9919, 2, 112, 78,
            true, false, new int[]{72, 565}),
    SLENDER(9913, 2, 112, 78,
            true, false, new int[]{72, 565}),
    LUFFY(9916, 2, 112, 78,
            true, false, new int[]{72, 565}),

    FAZULA(1311, 2, 128, 89,
            true, false, new int[]{89, 625}),
    YASUDA(1313, 2, 128, 89,
            true, false, new int[]{89, 625}),


    AGTHO(3013, 3, 92, 112,
            true, false, new int[]{25, 212}),
    ZERNATH(3831, 3, 92, 112,
            true, false, new int[]{25, 212}),

    SANCTUM(9017, 3, 112, 126,
            true, false, new int[]{29, 242}),
    ASMO(9903, 3, 112, 126,
            true, false, new int[]{29, 242}),

    VARTH(3016, 3, 128, 134,
            true, false, new int[]{32, 278}),
    EXODON(12239, 3, 128, 134,
            true, false, new int[]{32, 278}),
    ;
