...
public enum PlusUpgrades {
    ...
    OWNER_AURA_ATT(22238, new Item[]{
            new Item(23217, 10)
    }, new Item(23350, 1)),
    OWNER_AURA_ATT_1(23345, new Item[]{
            new Item(23217, 15)
    }, new Item(23351, 1)),
    OWNER_AURA_ATT_2(23346, new Item[]{
            new Item(23217, 20)
    }, new Item(23352, 1)),
    OWNER_AURA_ATT_3(23347, new Item[]{
            new Item(23218, 10)
    }, new Item(23353, 1)),
    OWNER_AURA_ATT_4(23348, new Item[]{
            new Item(23218, 15)
    }, new Item(23354, 1)),

    OWNER_HALO(22239, new Item[]{
            new Item(23217, 10)
    }, new Item(23355, 1)),
    OWNER_HALO_1(23355, new Item[]{
            new Item(23217, 15)
    }, new Item(23356, 1)),
    OWNER_HALO_2(23356, new Item[]{
            new Item(23217, 20)
    }, new Item(23357, 1)),
    OWNER_HALO_3(23357, new Item[]{
            new Item(23218, 10)
    }, new Item(23358, 1)),
    OWNER_HALO_4(23358, new Item[]{
            new Item(23218, 15)
    }, new Item(23359, 1)),

    OWNER_SHIELD(22240, new Item[]{
            new Item(23217, 10)
    }, new Item(23360, 1)),
    OWNER_SHIELD_1(23360, new Item[]{
            new Item(23217, 15)
    }, new Item(23361, 1)),
    OWNER_SHIELD_2(23361, new Item[]{
            new Item(23217, 20)
    }, new Item(23362, 1)),
    OWNER_SHIELD_3(23362, new Item[]{
            new Item(23218, 10)
    }, new Item(23363, 1)),
    OWNER_SHIELD_4(23363, new Item[]{
            new Item(23218, 15)
    }, new Item(23364, 1)),

    OWNER_NECKLACE(15834, new Item[]{
            new Item(23217, 10)
    }, new Item(23365, 1)),
    OWNER_NECKLACE_1(23365, new Item[]{
            new Item(23217, 15)
    }, new Item(23366, 1)),
    OWNER_NECKLACE_2(23366, new Item[]{
            new Item(23217, 20)
    }, new Item(23367, 1)),
    OWNER_NECKLACE_3(23367, new Item[]{
            new Item(23218, 10)
    }, new Item(23368, 1)),
    OWNER_NECKLACE_4(23368, new Item[]{
            new Item(23218, 15)
    }, new Item(23369, 1)),

    OWNER_RING(8832, new Item[]{
            new Item(23217, 10)
    }, new Item(23370, 1)),
    OWNER_RING_1(23370, new Item[]{
            new Item(23217, 15)
    }, new Item(23371, 1)),
    OWNER_RING_2(23371, new Item[]{
            new Item(23217, 20)
    }, new Item(23372, 1)),
    OWNER_RING_3(23372, new Item[]{
            new Item(23218, 10)
    }, new Item(23373, 1)),
    OWNER_RING_4(23373, new Item[]{
            new Item(23218, 15)
    }, new Item(23374, 1)),
