...
//
//	private static final String FILE_DIRECTORY = "./.core/server/clans/";
//
//	private static final ClanChat[] clans = new ClanChat[4000];
//
...
//		player.getPacketSender().sendString(29450, "Switch to Help Chat");
//		player.getPacketSender().sendString(29454, "Switch to Raids Chat");
