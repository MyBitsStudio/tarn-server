...
//
//    public static Position SPAWN_POINT = new Position(2143, 5016,8);
//
...
//
//                if (boss == 9906)
//                message = "The Final Boss Veigar has spawned at ::veigar";
...
//        currentBoss = new NPC(9906, new Position(2143, 5016,8));
//
//        World.register(currentBoss);
//        World.sendMessage(
//                "The Final Boss Veigar has spawned at ::veigar");
//        //JavaCord.sendMessage("\uD83E\uDD16│\uD835\uDDEE\uD835\uDDF0\uD835\uDE01\uD835\uDDF6\uD835\uDE03\uD835\uDDF6\uD835\uDE01\uD835\uDE06", "**The Final Boss Veigar has spawned at ::veigar**");
//    }
//}