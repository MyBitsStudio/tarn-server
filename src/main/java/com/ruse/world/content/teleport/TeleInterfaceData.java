...
public enum TeleInterfaceData {
    ...
    MONSTER5(TeleInterfaceCategory.MONSTERS, "Imperial Hound", 9838, 850, TeleInterfaceLocation.LOCATION6, null),
    MONSTER6(TeleInterfaceCategory.MONSTERS, "Imperial Scorpion", 9845, 1300, TeleInterfaceLocation.LOCATION7, null),
    MONSTER7(TeleInterfaceCategory.MONSTERS, "Imperial Ranger", 9910, 700, TeleInterfaceLocation.LOCATION8, null),
    MONSTER8(TeleInterfaceCategory.MONSTERS, "Imperial Paladin", 9807, 1350, TeleInterfaceLocation.LOCATION9, null),
    MONSTER9(TeleInterfaceCategory.MONSTERS, "Revenant Wyvern", 6692, 1050, TeleInterfaceLocation.LOCATION10, null),
    ...
    MONSTER13(TeleInterfaceCategory.MONSTERS, "Zinqrux", 8014, 850, TeleInterfaceLocation.LOCATION14, null),
    MONSTER14(TeleInterfaceCategory.MONSTERS, "Dr. Aberrant", 8003, 650, TeleInterfaceLocation.LOCATION15, null),
    MONSTER16(TeleInterfaceCategory.MONSTERS, "Inferno", 202, 850, TeleInterfaceLocation.LOCATION16, null),
    MONSTER17(TeleInterfaceCategory.MONSTERS, "Nagendra", 811, 850, TeleInterfaceLocation.LOCATION17, null),
    MONSTER18(TeleInterfaceCategory.MONSTERS, "Kol'gal", 9815, 1500, TeleInterfaceLocation.LOCATION18, null),
    MONSTER19(TeleInterfaceCategory.MONSTERS, "Yisdar", 9817, 1500, TeleInterfaceLocation.LOCATION19, null),
    MONSTER20(TeleInterfaceCategory.MONSTERS, "Ig'thaur", 9920, 1500, TeleInterfaceLocation.LOCATION20, null),
    MONSTER21(TeleInterfaceCategory.MONSTERS, "Zernath", 3831, 1200, TeleInterfaceLocation.LOCATION21, null),
    MONSTER22(TeleInterfaceCategory.MONSTERS, "Avalon", 9025, 1050, TeleInterfaceLocation.LOCATION22, null),
    MONSTER23(TeleInterfaceCategory.MONSTERS, "Eragon", 9026, 1050, TeleInterfaceLocation.LOCATION23, null),
    BOSS6(TeleInterfaceCategory.MONSTERS, "Doomwatcher", 9836, 1500, TeleInterfaceLocation.LOCATION24, null),
    BOSS34(TeleInterfaceCategory.MONSTERS, "Maze Guardian", 92, 1500, TeleInterfaceLocation.LOCATION25, null),
    BOSS30(TeleInterfaceCategory.MONSTERS, "Miscreation", 3313, 1500, TeleInterfaceLocation.LOCATION26, null),
    BOSS27(TeleInterfaceCategory.MONSTERS, "Avatar Titan", 8008, 1250, TeleInterfaceLocation.LOCATION27, null),
    BOSS28(TeleInterfaceCategory.MONSTERS, "Zorbak", 1906, 350, TeleInterfaceLocation.LOCATION28, null),
    MONSTER25(TeleInterfaceCategory.MONSTERS, "Death God", 9915, 750, TeleInterfaceLocation.LOCATION29, null),
    MONSTER26(TeleInterfaceCategory.MONSTERS, "Emerald Slayer", 2342, 1000, TeleInterfaceLocation.LOCATION30, null),
    ...
    BOSS8(TeleInterfaceCategory.BOSSES, "Mutant Hydra", 9839, 1650, TeleInterfaceLocation.LOCATION37, null),
    BOSS3(TeleInterfaceCategory.BOSSES, "Gorvek", 9806, 1950, TeleInterfaceLocation.LOCATION38, null),
    ...
    BOSS11(TeleInterfaceCategory.BOSSES, "Onyx Griffin", 1746, 1500, TeleInterfaceLocation.LOCATION42, null),
    ...
    BOSS19(TeleInterfaceCategory.BOSSES, "Tyrant Lord", 4972, 1500, TeleInterfaceLocation.LOCATION48, null),
    ...
    public static TeleInterfaceData[] forCategory(TeleInterfaceCategory category) {
