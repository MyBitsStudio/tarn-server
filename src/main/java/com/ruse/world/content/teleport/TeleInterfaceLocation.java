...
public enum TeleInterfaceLocation {
    ...
    LOCATION6(new Position(3487, 3615, 16), "Tier Ranking: 2 \\n \\n Multi: False \\n \\n KC Req: 50 Blurite Centaurs \\n \\n Recommended ELO: 0"), //hound
    LOCATION7(new Position(3487, 3615, 20), "Tier Ranking: 2 \\n \\n Multi: False \\n \\n KC Req: 60 Imperial Hounds \\n \\n Recommended ELO: 0"), //scorpion
    ...
    LOCATION17(new Position(2527, 2527, 16), "Tier Ranking: 8 \\n \\n Multi: True \\n \\n KC Req: 200 Infernos \\n \\n Recommended ELO: 47+"), //nagi
    LOCATION18(new Position(2964, 9478, 8), "Tier Ranking: 9 \\n \\n Multi: True \\n \\n KC Req: 300 Nagendras \\n \\n Recommended ELO: 58+"), //Kolgal
    LOCATION19(new Position(2964, 9478, 12), "Tier Ranking: 10 \\n \\n Multi: True \\n \\n KC Req: 300 Kol'gals \\n \\n Recommended ELO: 67+"), //Yisdar
    LOCATION20(new Position(2964, 9478, 16), "Tier Ranking: 11 \\n \\n Multi: True \\n \\n KC Req: 300 Yisdars \\n \\n Recommended ELO: 85+"), //Igthaur
    LOCATION21(new Position(2964, 9478, 20), "Tier Ranking: 12 \\n \\n Multi: True \\n \\n KC Req: 300 Ig'thaurs \\n \\n Recommended ELO: 90+"), //Zernath
    ...
    LOCATION40(new Position(2527, 2527, 68), "Tier Ranking: 30 \\n \\n Multi: True \\n \\n KC Req: 2K Dragonites \\n \\n Recommended ELO: 590+"), //Asmodeus
    LOCATION41(new Position(2527, 2527, 72), "Tier Ranking: 31 \\n \\n Multi: True \\n \\n KC Req: 2K Asmodeus's \\n \\n Recommended ELO: 650+"), //Malvek
    LOCATION42(new Position(2565, 2564, 76), "Tier Ranking: 32 \\n \\n Multi: True \\n \\n KC Req: 2K Malveks \\n \\n Recommended ELO: 670+"), //Griffin
    LOCATION43(new Position(2565, 2564, 80), "Tier Ranking: 33 \\n \\n Multi: True \\n \\n KC Req: 2K Onyx Griffins \\n \\n Recommended ELO: 684+"), //Zeidan
    LOCATION44(new Position(2565, 2564, 84), "Tier Ranking: 34 \\n \\n Multi: True \\n \\n KC Req: 2K Zeidan Grimms \\n \\n Recommended ELO: 750+"), //Agthomoth
    LOCATION45(new Position(2527, 2527, 84), "Tier Ranking: 35 \\n \\n Multi: True \\n \\n KC Req: 3K Ag'thomoths \\n \\n Recommended ELO: 780+"), //Lili
    LOCATION46(new Position(2527, 2527, 88), "Tier Ranking: 36 \\n \\n Multi: True \\n \\n KC Req: 3K Lilinryss's \\n \\n Recommended ELO: 838+"), //Groudon
    LOCATION47(new Position(2565, 2564, 92), "Tier Ranking: 37 \\n \\n Multi: True \\n \\n KC Req: 3K Groudons \\n \\n Recommended ELO: 900+"), //Varth
    LOCATION48(new Position(2565, 2564, 96), "Tier Ranking: 38 \\n \\n Multi: True \\n \\n KC Req: 3K Varthramoths \\n \\n Recommended ELO: 918+"), //Tyrant
    LOCATION49(new Position(2964, 9478, 96), "Tier Ranking: 39 \\n \\n Multi: True \\n \\n KC Req: 3K Tyrant Lords \\n \\n Recommended ELO: 980+"), //lucifer
    LOCATION50(new Position(2964, 9478, 100), "Tier Ranking: 40 \\n \\n Multi: True \\n \\n KC Req: 3K Lucifers \\n \\n Recommended ELO: 1010+"), //virtuoso
