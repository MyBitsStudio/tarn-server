...
//
//                                    if (o == Ores.AFKMINE) {
//                                        player.getInventory().add(17634, 10);
//                                        if (player.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId() == 19812) {
//                                            player.getInventory().add(17634, 10);
//                                        }
//                                     if (player.getEquipment().getItems()[Equipment.HEAD_SLOT].getId() == 14068) {
//                                            player.getInventory().add(17634, 10);
//                                        }
//                                     if (player.getEquipment().getItems()[Equipment.BODY_SLOT].getId() == 14069) {
//                                            player.getInventory().add(17634, 10);
//                                        }
//                                     if (player.getEquipment().getItems()[Equipment.LEG_SLOT].getId() == 14070) {
//                                            player.getInventory().add(17634, 10);
//                                        }
//                                     if (player.getEquipment().getItems()[Equipment.AMULET_SLOT].getId() == 14073) {
//                                            player.getInventory().add(17634, 10);
//                                        }
//                                     if (player.getEquipment().getItems()[Equipment.HANDS_SLOT].getId() == 14071) {
//                                            player.getInventory().add(17634, 10);
//                                        }
//                                     if (player.getEquipment().getItems()[Equipment.FEET_SLOT].getId() == 14072) {
//                                            player.getInventory().add(17634, 10);
//                                        }
//                                    if (player.getSummoning().getFamiliar() != null && player.getSummoning().getFamiliar().getSummonNpc() != null && player.getSummoning().getFamiliar().getSummonNpc().getId() == 4444) {
//                                        player.getInventory().add(17634, 20);
//                                    }
//                                        }
//
