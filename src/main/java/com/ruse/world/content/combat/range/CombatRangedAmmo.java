...
public class CombatRangedAmmo {
	...
	public enum RangedWeaponData {
		...
		ARMADYL_CROSSBOW(new int[] { 22034, 18799, 18358, 23066, 4022},
		...
		GINREI_KOJAKU(new int[] { 22010, 16337, 21018, 22134, 20497,21053,21054,21055,21056}, new AmmunitionData[] { AmmunitionData.ZARYTE_AMMO },
				RangedWeaponType.BSOAT),
		AOEWEAPONS(new int[] {3738 }, new AmmunitionData[] { AmmunitionData.AOE_AMMO },
				RangedWeaponType.BSOAT),
		MINIGUN(new int[] { 4017, 19137, 19136, 19843, 9941, 5012, 12843, 18636,8088,5073,8411,22148,5011,22113,5010,8001,21606,15785,14919, 8253,22089,7543,2632,9929,14056, 20173, 671, 16879,18332, 22083, 2040, 2074, 2158, 2206, 2220, 2296, 22115, 2470, 14343, 2550, 2632, 2658 },
