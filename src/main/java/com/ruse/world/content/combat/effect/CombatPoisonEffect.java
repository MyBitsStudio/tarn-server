...
public class CombatPoisonEffect extends Task {
	...
	public enum PoisonType {
		MILD(50), EXTRA(70), SUPER(120), BRUTAL(120000);
	...
	public void execute() {
		...
		entity.dealDamage(new Hit(entity.getAndDecrementPoisonDamage(), Hitmask.POISON, CombatIcon.NONE));
		entity.getCombatBuilder().addDamage(entity, entity.getPoisonDamage());
		/*
		 * if(entity.isPlayer()) {
...
//			types.put(5664, PoisonType.SUPER);
			...
			types.put(15222, PoisonType.BRUTAL);
		}
