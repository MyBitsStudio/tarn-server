...
public class Vetion implements CombatStrategy {
	...
	public boolean customContainerAttack(Character entity, Character victim) {
		...
		if (Locations.goodDistance(vetion.getPosition().copy(), victim.getPosition().copy(), 3)
				&& Misc.getRandom(5) <= 3) {
			vetion.performAnimation(new Animation(11020));
			...
			final Position start3 = new Position(2146, 5011);
			final Position start4 = new Position(2147, 5020);
			final Position start5 = new Position(2139, 5020);
			final Position start6 = new Position(2138, 5016);
