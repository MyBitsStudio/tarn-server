...
public class ButtonClickPacketListener implements PacketListener {
    ...
    public void handleMessage(Player player, Packet packet) {
        ...
        if(AchievementHandler.onButtonClick(player, id))
            return;
        if(TaskScrollHandler.handleButtonClick(player, id))
            return;
...
//                break;
            ...
            case 22004:
              /*  if (!player.isBanking())
                ...
                player.sendMessage("Bank search option is currently disabled.");
                break;
            case 22845:
            case 24115:
            case 24010:
            ...
            case 150:
                if (player.getLocation() == Location.AURA) {
                    player.sendMessage("Auto Retaliate is not allowed in this raid.");
                     }
