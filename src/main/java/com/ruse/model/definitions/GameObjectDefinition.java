...
public final class GameObjectDefinition {
	...
	public static boolean removedObject(int id) {
		return id == 11328 || id == 2956 || id == 463 || id == 462 || id == 25026 || id == 25020 || id == 25019
				...
				|| id == 36846 || id == 1508 || id == 1506 || id == 4031 || id == 2913;
	}
	...
	public static GameObjectDefinition forId(int i) {
		...
		/* Removing doors etc */
		boolean removeObject = i == 7332 || i == 7326 || i == 7325 ||  i == 7331 || i == 7385 || i == 7320
				...
				|| i == 40108 || i == 59 || i == 2069 || i == 36846 || i == 1508 || i == 1506 || i == 4031 || i == 2913;
		if (removeObject) {
