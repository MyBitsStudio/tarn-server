...
public final class WeaponInterfaces {
	...
	public static void assign(Player player, Item item) {
		...
		if (weapon == WeaponInterface.UNARMED) {
			...
			player.getPacketSender().sendString(weapon.getNameLineId() - 1, "Weapon: ");
		} else if (weapon == WeaponInterface.SPEAR) {
			player.getPacketSender().sendString(weapon.getNameLineId() - 1, "Weapon: ");
		}
	...
	public static void init() {
		...
		for (int id = 0; id < count; id++) {
			...
			} else if (lowerName.contains("scimitar") || lowerName.contains("sickle")) {
				weaponInterface = WeaponInterface.SCIMITAR;
			} else if (lowerName.contains("longsword") || lowerName.contains("katana") || lowerName.contains("glaive")) {
			...
			} else if (lowerName.contains("hammers") || lowerName.contains("hammer") || lowerName.contains("maul")) {
