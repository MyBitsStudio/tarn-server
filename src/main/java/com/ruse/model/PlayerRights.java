...
public enum PlayerRights {
	...
	OBSIDIAN_DONATOR(-1, "@bla@<shad=0>", 1, 1), // The highest-privileged member of the server
	
	DEVELOPER(-1, "<col=0><shad=B40404>", 1, 1),
	HELPER(-1, "<col=0><shad=FFFFFF>", 1, 1),

	GRACEFUL_DONATOR(60, "@blu@<shad=0>", 1, 1),
	CLERIC_DONATOR(45, "@gre@<shad=0>", 1, 1),
	TORMENTED_DONATOR(30, "@red@<shad=0>", 1, 1),
	MYSTICAL_DONATOR(15, "@whi@<shad=0>", 1, 1),

	YOUTUBER(-1, "<col=CD201F><shad=ffffff>", 1, 1),
	CRAP(-1, "<col=0><shad=FFFFFF>", 1, 1),
	SUPPORT(-1, "<col=FFFFFF><shad=0>", 1, 1),
	FORSAKEN_DONATOR(-1, "@bla@<shad=0>", 1, 1);
	...
	private static final ImmutableSet<PlayerRights> MEMBERONLY = Sets.immutableEnumSet(GRACEFUL_DONATOR, CLERIC_DONATOR,
			MYSTICAL_DONATOR, TORMENTED_DONATOR, HELPER, MODERATOR, ADMINISTRATOR, OBSIDIAN_DONATOR, FORSAKEN_DONATOR, DEVELOPER, YOUTUBER);
	private static final ImmutableSet<PlayerRights> REGULARDONATORONLY = Sets.immutableEnumSet(GRACEFUL_DONATOR, CLERIC_DONATOR,
			MYSTICAL_DONATOR, TORMENTED_DONATOR, HELPER, MODERATOR, ADMINISTRATOR, OBSIDIAN_DONATOR, FORSAKEN_DONATOR, DEVELOPER, YOUTUBER);
	private static final ImmutableSet<PlayerRights> SUPERDONATORONLY = Sets.immutableEnumSet(CLERIC_DONATOR,
			MYSTICAL_DONATOR, TORMENTED_DONATOR, HELPER, MODERATOR, ADMINISTRATOR, OBSIDIAN_DONATOR, FORSAKEN_DONATOR, DEVELOPER, YOUTUBER);
	private static final ImmutableSet<PlayerRights> EXTREMEDONATORONLY = Sets.immutableEnumSet(MYSTICAL_DONATOR,
			TORMENTED_DONATOR, HELPER, MODERATOR, ADMINISTRATOR, OBSIDIAN_DONATOR, FORSAKEN_DONATOR, DEVELOPER, YOUTUBER);
	private static final ImmutableSet<PlayerRights> SPONSORDONATORONLY = Sets.immutableEnumSet(MYSTICAL_DONATOR,
			MODERATOR, ADMINISTRATOR, OBSIDIAN_DONATOR, FORSAKEN_DONATOR, DEVELOPER, YOUTUBER);

	private static final ImmutableSet<PlayerRights> CONTRIBUTORONLY = Sets.immutableEnumSet(GRACEFUL_DONATOR, CLERIC_DONATOR,
			TORMENTED_DONATOR, MYSTICAL_DONATOR, SUPPORT, HELPER, MODERATOR, ADMINISTRATOR, OBSIDIAN_DONATOR, FORSAKEN_DONATOR, DEVELOPER, YOUTUBER);
	private static final ImmutableSet<PlayerRights> MEMBERS = Sets.immutableEnumSet(GRACEFUL_DONATOR, CLERIC_DONATOR,
			TORMENTED_DONATOR, MYSTICAL_DONATOR, SUPPORT, HELPER, MODERATOR, ADMINISTRATOR, OBSIDIAN_DONATOR, FORSAKEN_DONATOR, DEVELOPER, YOUTUBER);
	private static final ImmutableSet<PlayerRights> REGULAR = Sets.immutableEnumSet(PLAYER, HELPER);
	private static final ImmutableSet<PlayerRights> NOTMEMBER = Sets.immutableEnumSet(PLAYER, GRACEFUL_DONATOR);
